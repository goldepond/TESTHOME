...
| 문서 | 경로 | 역할 |
|------|------|------|
| UI-SPEC.md | `docs/common/UI-SPEC.md` | 디자인 시스템 전체 스펙 (10개 섹션) |
| UI-REVIEW.md | `docs/common/UI-REVIEW.md` | 6축 시각 감사 (정량 분석) |
| ux-analysis-seller.md | `docs/seller/ux-analysis-seller.md` | 매도자 UX 분석 |
| ux-analysis-broker.md | `docs/broker/ux-analysis-broker.md` | 중개사 UX 분석 |
| ux-analysis-buyer.md | `docs/buyer/ux-analysis-buyer.md` | 구매자 UX 분석 |
| ux-analysis-admin.md | `docs/admin/ux-analysis-admin.md` | 관리자 UX 분석 |
| structural-issues.md | `docs/common/structural-issues.md` | 구조적 이슈 |
